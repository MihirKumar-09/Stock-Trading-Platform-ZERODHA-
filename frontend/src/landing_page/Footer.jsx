      ...
      <div className="container mt-5">
        <div className="row mt-5">
          <div className="col">
            ...
            />
            <p>
              &copy; 2010 - 2026, Not Zerodha Broking Ltd. <br /> All rights
              reserved
            </p>
          </div>
        ...
        <div className="row p-5">
          ...
          <div className="d-flex justify-content-center gap-4 fw-medium">
            <p style={{ fontSize: "0.9rem" }}>
              <a
                className="link-offset-2 link-underline link-underline-opacity-0 text-muted"
                href="#"
              >
                NSE
              </a>
